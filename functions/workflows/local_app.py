...
from .service import WorkflowService, derive_key_point, derive_next_step, derive_specific_title
...
def _local_note_generator(source_text, context_hint, profile, api_key, allow_next_step=True):
    return {
        ...
        "next_step": derive_next_step(source_text) if allow_next_step else "",
    }
